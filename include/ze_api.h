...
///////////////////////////////////////////////////////////////////////////////
typedef void (ZE_APICALL *ze_pfnGraphCreateCb_t)(
    ze_device_handle_t hDevice,                     ///< [in] handle of the device
    const ze_graph_desc_t* desc,                    ///< [in] pointer to graph descriptor
    ze_graph_handle_t* phGraph                      ///< [out] pointer to handle of graph object created
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef void (ZE_APICALL *ze_pfnGraphDestroyCb_t)(
    ze_graph_handle_t hGraph                        ///< [in][release] handle of graph object to destroy
    );

///////////////////////////////////////////////////////////////////////////////
typedef void (ZE_APICALL *ze_pfnGraphGetPropertiesCb_t)(
    ze_graph_handle_t hGraph,                       ///< [in] handle of the graph object
    ze_graph_properties_t* pGraphProperties         ///< [in,out] query result for graph properties.
    );

///////////////////////////////////////////////////////////////////////////////
typedef void (ZE_APICALL *ze_pfnGraphGetArgumentPropertiesCb_t)(
    ze_graph_handle_t hGraph,                                   ///< [in] handle of the graph object
    uint32_t argIndex,                                          ///< [in] index of the argument to get properties
    ze_graph_argument_properties_t* pGraphArgumentProperties    ///< [in,out] query result for graph argument properties.
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef void (ZE_APICALL *ze_pfnGraphSetArgumentValueCb_t)(
    ze_graph_handle_t hGraph,
    uint32_t argIndex,
    const void* pArgValue
    );
...
///////////////////////////////////////////////////////////////////////////////
typedef void (ZE_APICALL *ze_pfnAppendGraphInitializeCb_t)(
    ze_command_list_handle_t hCommandList,          ///< [in] handle of the command list
    ze_graph_handle_t hGraph                        ///< [in] handle of the graph
    );

///////////////////////////////////////////////////////////////////////////////
typedef void (ZE_APICALL *ze_pfnAppendGraphExecuteCb_t)(
    ze_command_list_handle_t hCommandList,          ///< [in] handle of the command list
    ze_graph_handle_t hGraph                        ///< [in] handle of the graph
    );
...
typedef struct _ze_graph_callbacks_t
{
    ze_pfnGraphCreateCb_t                                       pfnCreate;
    ze_pfnGraphDestroyCb_t                                      pfnDestroy;
    ze_pfnGraphSetArgumentValueCb_t                             pfnSetArgumentValue;
    ze_pfnGraphGetPropertiesCb_t                                pfnGetProperties;
    ze_pfnGraphGetArgumentPropertiesCb_t                        pfnGetArgumentProperties;
    ze_pfnAppendGraphInitializeCb_t                             pfnAppendGraphInitialize;
    ze_pfnAppendGraphExecuteCb_t                                pfnAppendGraphExecute;
} ze_graph_callbacks_t;
